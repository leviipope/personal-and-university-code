...
public class Etel implements Comparable<Etel>{
    ...
    /**
     * Ay etel osztalyhoz hoz letre egy peldanyt
     * @param nev
     * @param vonalkod
     * @param ar
     * @param lejaratDatuma
    ...
    /**
     * Visszaadja az etel nevet
     * @return az etel neve
     */
    public String getNev() {return nev;}
    public String getVonalkod() {return vonalkod;}
    public double getAr() {return ar;}
    public LocalDate getLejaratDatuma() {return lejaratDatuma;}
    public String getEtelTipus() {return etelTipus;}
    ...
    /**
     * osszehasonlit 2 etel objektumot
     * @param o az etel amivel hasonlitunk
     * @return igaz ha a vonalkod es az eteltipus megegyezik, egyebeknt hamis
     */
    @Override
